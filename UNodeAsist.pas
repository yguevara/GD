...
uses
  ...
  Vcl.ComCtrls, Vcl.StdCtrls, CnButtons, CnPanel,
...
begin
  if MessageDlg('¿Realmente desea salir del asistente de creación de nodos?', mtConfirmation, [mbYes, mbNo], 0) = mrYes then
  begin
    CanClose := True
  end
  else
